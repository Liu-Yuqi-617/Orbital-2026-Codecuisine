...
// cuisineMapping: Google Places type → standardized cuisine
// Extracted as package-level variable, shared by InferCuisineType and GetAllCuisineTypes
var cuisineMapping = map[string]string{
	// Asian
...
// GetAllCuisineTypes returns all unique standardized cuisines
func GetAllCuisineTypes() []string {
	seen := make(map[string]struct{})
	result := make([]string, 0)

	for _, cuisine := range cuisineMapping {
