    ...
    useEffect(() => {
        const loadStats = async () => {
            try {
                ...
                const avgOverall =
                    totalCount > 0 ? totalRatingSum / totalCount : 0;
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="trust-tips">
                                ...
                                <ul>
                                    <li>
                                        Write more reviews (+base points)
                                    </li>
                                    <li>
                                        Upload receipt photos for verification
                                        (+40% bonus)
                                    </li>
                                    <li>
                                        Use GPS check-in when visiting
                                        (+diversity bonus)
                                    </li>
                                    <li>
                                        Higher trust = your reviews carry more
                                        weight!
                                    </li>
                                </ul>
                            </div>
